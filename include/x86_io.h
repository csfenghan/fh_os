...
static inline void lcr0(uint32_t val) { asm volatile("movl %0,%%cr0" : : "r"(val)); }
...
static inline void lcr4(uint32_t val) { asm volatile("movl %0,%%cr4" : : "r"(val)); }
...
static inline void cpuid(uint32_t info, uint32_t *eaxp, uint32_t *ebxp, uint32_t *ecxp,
                         uint32_t *edxp) {
